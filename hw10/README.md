...
###
[Transmitter](transmitter.c) спращивает PID ресивера, которому нужно передать число типа long. \
[Receiver](receiver.c) обрабатывает сигналы "побитно" для соответствующего передаваемого числа. 
### Пример работы программы:
![screenshot](sem10_ex.png)
